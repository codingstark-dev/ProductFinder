...
class OpenFoodFact {
  ...
  factory OpenFoodFact.fromRawJson(String str) =>
      OpenFoodFact.fromJson(json.decode(str));
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
        ...
        ecoscoreGrade: ecoscoreGradeValues.map[json["ecoscore_grade"]] ?? EcoscoreGrade.A,
        ecoscoreScore: json["ecoscore_score"],
        ecoscoreTags: json["ecoscore_tags"] == null
            ? []
            : List<EcoscoreGrade>.from(
                json["ecoscore_tags"]!.map((x) => ecoscoreGradeValues.map[x] ?? EcoscoreGrade.A)),
        ...
        ingredientsWithoutCiqualCodes:
            json["ingredients_without_ciqual_codes"] == null
                ? []
                : List<String>.from(
        ...
        nutriscore2021Tags: json["nutriscore_2021_tags"] == null
            ? []
            : List<EcoscoreGrade>.from(json["nutriscore_2021_tags"]!
                .map((x) => ecoscoreGradeValues.map[x]!)),
        nutriscore2023Tags: json["nutriscore_2023_tags"] == null
            ? []
        ...
        nutriscoreTags: json["nutriscore_tags"] == null
            ? []
            : List<EcoscoreGrade>.from(json["nutriscore_tags"]!
                .map((x) => ecoscoreGradeValues.map[x]!)),
        ...
        nutritionGradesTags: json["nutrition_grades_tags"] == null
            ? []
            : List<EcoscoreGrade>.from(json["nutrition_grades_tags"]!
                .map((x) => ecoscoreGradeValues.map[x]!)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "ingredients_with_unspecified_percent_sum":
            ingredientsWithUnspecifiedPercentSum,
        "ingredients_without_ciqual_codes": ingredientsWithoutCiqualCodes ==
                null
            ? []
        ...
        "nutriscore_2021_tags": nutriscore2021Tags == null
            ? []
            : List<dynamic>.from(
                nutriscore2021Tags!.map((x) => ecoscoreGradeValues.reverse[x])),
        "nutriscore_2023_tags": nutriscore2023Tags == null
            ? []
        ...
        "nutriscore_tags": nutriscoreTags == null
            ? []
            : List<dynamic>.from(
                nutriscoreTags!.map((x) => ecoscoreGradeValues.reverse[x])),
        ...
        "nutrition_grades_tags": nutritionGradesTags == null
            ? []
            : List<dynamic>.from(nutritionGradesTags!
                .map((x) => ecoscoreGradeValues.reverse[x])),
...
class CategoriesProperties {
  ...
  factory CategoriesProperties.fromRawJson(String str) =>
      CategoriesProperties.fromJson(json.decode(str));
...
class EcoscoreData {
  ...
  factory EcoscoreData.fromRawJson(String str) =>
      EcoscoreData.fromJson(json.decode(str));
  ...
  factory EcoscoreData.fromJson(Map<String, dynamic> json) => EcoscoreData(
        ...
        grades: Map.from(json["grades"]!).map((k, v) =>
            MapEntry<String, EcoscoreGrade>(k, ecoscoreGradeValues.map[v]?? EcoscoreGrade.A)),
        missing:
        ...
        previousData: json["previous_data"] == null
            ? null
            : PreviousData.fromJson(json["previous_data"]),
        score: json["score"],
        scores: Map.from(json["scores"]!)
...
class Adjustments {
  ...
  factory Adjustments.fromRawJson(String str) =>
      Adjustments.fromJson(json.decode(str));
...
class OriginsOfIngredients {
  ...
  factory OriginsOfIngredients.fromRawJson(String str) =>
      OriginsOfIngredients.fromJson(json.decode(str));
  ...
  factory OriginsOfIngredients.fromJson(Map<String, dynamic> json) =>
      OriginsOfIngredients(
        ...
        originsFromCategories: json["origins_from_categories"] == null
            ? []
            : List<String>.from(json["origins_from_categories"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "epi_score": epiScore,
        "epi_value": epiValue,
        "origins_from_categories": originsFromCategories == null
            ? []
            : List<dynamic>.from(originsFromCategories!.map((x) => x)),
...
class AggregatedOrigin {
  ...
  factory AggregatedOrigin.fromRawJson(String str) =>
      AggregatedOrigin.fromJson(json.decode(str));
...
class Packaging {
  ...
  factory Packaging.fromRawJson(String str) =>
      Packaging.fromJson(json.decode(str));
...
class ProductionSystem {
  ...
  factory ProductionSystem.fromRawJson(String str) =>
      ProductionSystem.fromJson(json.decode(str));
...
class ThreatenedSpecies {
  ...
  factory ThreatenedSpecies.fromRawJson(String str) =>
      ThreatenedSpecies.fromJson(json.decode(str));
...
class Agribalyse {
  ...
  factory Agribalyse.fromRawJson(String str) =>
      Agribalyse.fromJson(json.decode(str));
...
class PreviousData {
  ...
  factory PreviousData.fromRawJson(String str) =>
      PreviousData.fromJson(json.decode(str));
...
class Images {
  ...
  factory Images.fromJson(Map<String, dynamic> json) => Images(
        ...
        frontEn:
            json["front_en"] == null ? null : En.fromJson(json["front_en"]),
        ingredientsEn: json["ingredients_en"] == null
            ? null
            : En.fromJson(json["ingredients_en"]),
        nutritionEn: json["nutrition_en"] == null
            ? null
            : En.fromJson(json["nutrition_en"]),
        packagingEn: json["packaging_en"] == null
            ? null
            : En.fromJson(json["packaging_en"]),
      );
...
class ProductIngredient {
  ...
  factory ProductIngredient.fromRawJson(String str) =>
      ProductIngredient.fromJson(json.decode(str));
  ...
  factory ProductIngredient.fromJson(Map<String, dynamic> json) =>
      ProductIngredient(
        ...
        ingredients: json["ingredients"] == null
            ? []
            : List<PurpleIngredient>.from(
                json["ingredients"]!.map((x) => PurpleIngredient.fromJson(x))),
...
class PurpleIngredient {
  ...
  factory PurpleIngredient.fromRawJson(String str) =>
      PurpleIngredient.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PurpleIngredient.fromJson(Map<String, dynamic> json) =>
      PurpleIngredient(
        ciqualProxyFoodCode: json["ciqual_proxy_food_code"],
        id: json["id"],
        percentEstimate: json["percent_estimate"]?.toDouble(),
        ...
        ingredients: json["ingredients"] == null
            ? []
            : List<FluffyIngredient>.from(
                json["ingredients"]!.map((x) => FluffyIngredient.fromJson(x))),
        origins: json["origins"],
      );
...
class FluffyIngredient {
  ...
  factory FluffyIngredient.fromRawJson(String str) =>
      FluffyIngredient.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory FluffyIngredient.fromJson(Map<String, dynamic> json) =>
      FluffyIngredient(
        id: json["id"],
        percentEstimate: json["percent_estimate"]?.toDouble(),
        percentMax: json["percent_max"]?.toDouble(),
...
class IngredientsAnalysis {
  ...
  factory IngredientsAnalysis.fromRawJson(String str) =>
      IngredientsAnalysis.fromJson(json.decode(str));
  ...
  factory IngredientsAnalysis.fromJson(Map<String, dynamic> json) =>
      IngredientsAnalysis(
        ...
        enPalmOil: json["en:palm-oil"] == null
            ? []
            : List<String>.from(json["en:palm-oil"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "en:palm-oil": enPalmOil == null
            ? []
            : List<dynamic>.from(enPalmOil!.map((x) => x)),
        "en:vegan-status-unknown": enVeganStatusUnknown == null
            ? []
            : List<dynamic>.from(enVeganStatusUnknown!.map((x) => x)),
        "en:vegetarian-status-unknown": enVegetarianStatusUnknown == null
            ? []
...
class LanguagesCodes {
  ...
  factory LanguagesCodes.fromRawJson(String str) =>
      LanguagesCodes.fromJson(json.decode(str));
...
class NutrientLevels {
  ...
  factory NutrientLevels.fromRawJson(String str) =>
      NutrientLevels.fromJson(json.decode(str));
...
class Nutriments {
  ...
  final num? transFat;
  final num? transFat100G;
  final num? transFatServing;
  final String? transFatUnit;
  final num? transFatValue;
...
class Nutriscore {
  ...
  factory Nutriscore.fromRawJson(String str) =>
      Nutriscore.fromJson(json.decode(str));
...
class Data {
  ...
  final num? countProteins;
  final String? countProteinsReason;
  final num? isFatOilNutsSeeds;
  final num? isRedMeatProduct;
  final num? negativePointsMax;
  final List<String>? positiveNutrients;
  final num? positivePointsMax;
...
class Components {
  ...
  factory Components.fromJson(Map<String, dynamic> json) => Components(
        negative: json["negative"] == null
            ? []
            : List<Tive>.from(json["negative"]!.map((x) => Tive.fromJson(x))),
        positive: json["positive"] == null
            ? []
            : List<Tive>.from(json["positive"]!.map((x) => Tive.fromJson(x))),
      );
...
class NutriscoreData {
  ...
  factory NutriscoreData.fromRawJson(String str) =>
      NutriscoreData.fromJson(json.decode(str));
...
class PackagingsMaterials {
  ...
  factory PackagingsMaterials.fromRawJson(String str) =>
      PackagingsMaterials.fromJson(json.decode(str));
...
class SelectedImages {
  ...
  factory SelectedImages.fromRawJson(String str) =>
      SelectedImages.fromJson(json.decode(str));
